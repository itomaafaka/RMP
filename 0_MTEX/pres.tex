...
\begin{frame}
    \centering\Large\textbf{1. Счлучайность и риск}
\end{frame}
...
\begin{frame}{}
    ...
    \centering\Large\textbf{Теория вероятностей как язык}
\end{frame}
...
\begin{itemize}
    ...
    \item Требуется управление чувствительностью портфеля: дельта, гамма, вега.
